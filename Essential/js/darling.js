...
function pinker1(){
  ...
  if ($(window).width() < 800) {
    ...
    Array.from(document.querySelectorAll(".text2,.email, .discord, h1 strong, button, .btn, .menubtn, li a, .box h2, .apply, .clock, .box, .playlist")).forEach(el => el.classList.add("pink"));
