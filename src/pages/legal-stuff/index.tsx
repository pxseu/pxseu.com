...
const LovesIndex = () => (
	<>
		<DefaultLayout title={"Terms of Service | Privacy Policy"}>
			...
			<p>
				3. I do not guarantee the state of the files for you. They can be deleted at any
				point for storage / update reasons.
			</p>
			<p>
				4. Only one account is allowed per one user. (no second accounts will be tolerated)
			</p>
			...
			<div>
				...
				<p>All of the data that you input / give will be stored in the proper way.</p>
				<p>
					All your data can be deleted with the account deletion process from the
					dashboard.
				</p>
			</div>
			<hr />
