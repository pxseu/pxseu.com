...
const LovesIndex = (): JSX.Element => (
	<DefaultLayout title={"Terms of Service | Privacy Policy"}>
		...
		<p>
			3. I do not guarantee the state of the files for you. They can be deleted at any point
			for storage / update reasons.
		</p>
		...
		<div>
			...
			<p>
				All your data can be deleted with the account deletion process from the dashboard.
			</p>
		</div>
		<hr />
		<h4>
