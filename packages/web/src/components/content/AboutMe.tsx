	...
	return (
		...
		>
			...
			<Text fontSize="lg" padding={3}>
				Since you&apos;re here allow me to introduce myself. My name is Kuba and I&apos;m a {Math.floor(age)}{" "}
				year old software and web developer from Poland with over {Math.floor(codingFor)} years of experience. I
				love free and open source software but like most of us I use a huge amount of proprietary software. In
				my free time I usually listen to “emo/sad” songs or watch anime, but recently I haven’t had much time
				for that. Helping others solve programming issues brings me a lot of joy and is one of the reasons why I
				love open source so much. Feel free to message me anywhere in{" "}
